#!/usr/bin/env python3
"""
Feature Implementation: [BOUNTY $150] AGENT: Claude Code sub-agent that reviews PR
...
class bounty150AgentClaudeCodeSubAgentThatReviewsPrFeature(FeatureBase):
    """Concrete implementation of the [BOUNTY $150] AGENT: Claude Code sub-agent that reviews PR feature"""
...
def create_feature(config: Optional[Dict[str, Any]] = None):
    ...
    feature = bounty150AgentClaudeCodeSubAgentThatReviewsPrFeature(config)
